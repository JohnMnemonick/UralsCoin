...
static bool InitHTTPAllowList()
{
    ...
    if (mapMultiArgs.count("-rpcallowip")) {
        const std::vector<std::string>& vAllow = mapMultiArgs.at("-rpcallowip"); //mapMultiArgs["-rpcallowip"];
...
static bool HTTPBindAddresses(struct evhttp* http)
{
    ...
    if (!mapMultiArgs.count("-rpcallowip")) { // Default to loopback if not allowing external IPs
        ...
        const std::vector<std::string>& vbind = mapMultiArgs.at("-rpcbind"); //mapMultiArgs["-rpcbind"];
