...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-anonymizedashamount=<n>", strprintf(_("Keep N URALS anonymized (default: %u)"), nAnonymizeDashAmount));
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://www.uralscoin.info>";
